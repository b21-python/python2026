...
We will review [python101](../day1/python101.md) from previous weeks and then go over [python102](./python102.md)

## Learn new python

Go to [Random and Scrolling](./randomAndScrolling.md)
